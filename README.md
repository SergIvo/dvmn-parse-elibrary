...
Приложение предназначено для скачивания книг из раздела "Научная фантастика" онлайн-библиотеки [https://tululu.org/l55/](https://tululu.org/l55/). 
Приложение запускается из командной строки и скачивает книги с указанных страниц раздела, либо все книги из раздела. Интервал страниц указывается при запуске
